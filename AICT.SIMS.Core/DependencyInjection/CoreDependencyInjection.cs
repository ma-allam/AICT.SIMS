...
using AICT.SIMS.Core.Auth.Contract;
using AICT.SIMS.Core.Auth.JWT;
using AICT.SIMS.Core.Auth.User;
using AICT.SIMS.Core.Cache;
using AICT.SIMS.Core.Crypto;
using AICT.SIMS.Core.Interfaces;
...
namespace AICT.SIMS.Core.DependencyInjection
{
