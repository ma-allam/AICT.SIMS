...
namespace AICT.SIMS.WebApi.EndPoints.UserManagement.Command
{
    ...
    .WithActionResult<LoginEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "Login", Description = "Login ", OperationId = "AICT.SIMS.WebApi.EndPoints.UserManagement.Login", Tags = new[] { "AICT.SIMS.WebApi.EndPoints.UserManagement" })]
